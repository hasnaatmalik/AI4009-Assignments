...
3.  **Run the Gradio App:**
    ...
    *Alternatively, you can run it directly from this folder:*
    ...
    The Gradio application will automatically utilize the M2 Mac GPU (`mps` backend) and launch locally in your browser at `http://127.0.0.1:7860`.
    *Note: A `flagged/` folder is generated by Gradio when you use the app, which is ignored by git.*
